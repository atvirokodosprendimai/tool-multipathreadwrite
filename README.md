...
**Status: stable at v1.21.1 (2026-09-15), the tag cut from `d3eb19e`.** Break campaign for it: [docs/break/campaign-v1.21.1.txt](docs/break/campaign-v1.21.1.txt), 55 probes, exit codes identical to v1.21.0.
