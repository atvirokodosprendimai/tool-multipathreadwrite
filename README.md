...
**Status: stable at v1.22.1 (2026-09-16), the tag cut from `e1f73e4`.** Break campaign for it: [docs/break/campaign-v1.22.1.txt](docs/break/campaign-v1.22.1.txt), 55 probes, exit codes identical to v1.22.0.
