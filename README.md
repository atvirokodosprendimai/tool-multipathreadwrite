...
**Status: stable at v1.17.0 (2026-09-13), the tag cut from `c6a97cd`.** Break campaign for it: [docs/break/campaign-v1.17.0.txt](docs/break/campaign-v1.17.0.txt), 47 probes, exit codes identical to v1.16.1.
