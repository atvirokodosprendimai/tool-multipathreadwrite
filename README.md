...
**Status: stable at v1.18.0 (2026-09-13), the tag cut from `a5c4f24`.** Break campaign for it: [docs/break/campaign-v1.18.0.txt](docs/break/campaign-v1.18.0.txt), 47 probes, exit codes identical to v1.17.0.
