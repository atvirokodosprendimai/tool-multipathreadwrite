...
**Status: stable at v1.24.0 (2026-09-24), the tag cut from `7da61c1`.** Break campaign for it: [docs/break/campaign-v1.24.0.txt](docs/break/campaign-v1.24.0.txt), 57 probes, exit codes identical to v1.23.0.
