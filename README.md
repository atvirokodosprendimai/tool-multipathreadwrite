...
**Status: stable at v1.28.0 (2026-09-26), the tag cut from `1ae5df9`.** Break campaign for it: [docs/break/campaign-v1.28.0.txt](docs/break/campaign-v1.28.0.txt), 57 probes, exit codes identical to v1.27.1.
