...
**Status: stable at v1.22.2 (2026-09-24), the tag cut from `47b8fe9`.** Break campaign for it: [docs/break/campaign-v1.22.2.txt](docs/break/campaign-v1.22.2.txt), 55 probes, exit codes identical to v1.22.1.
