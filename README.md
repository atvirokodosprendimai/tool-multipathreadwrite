...
answer** — and seventeen readings have been taken under it: four void under their own rules (1, 6, 7, and 15 on format), one evidence-limited under its own (14), and eleven with results; reading 12, the MCP arm, waits on ADR-023. Every plan was committed before its trials
