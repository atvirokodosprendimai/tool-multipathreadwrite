...
**Status: stable at v1.24.1 (2026-09-25), the tag cut from `ef3d675`.** Break campaign for it: [docs/break/campaign-v1.24.1.txt](docs/break/campaign-v1.24.1.txt), 57 probes, exit codes identical to v1.24.0.
