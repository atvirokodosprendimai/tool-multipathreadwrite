...
answer** — and thirteen readings have been taken under it: three void under their own rules (1, 6, 7), one evidence-limited under its own (14), and nine with results; reading 12, the MCP arm, waits on ADR-023. Every plan was committed before its trials
...
nothing.** Measured twice, on two different tasks, through the reader; a thirteen-service fixture through the tool result (reading 14) says the same on its fifteen strictly compliant trials, and reading 17 will say it at the pre-registered strength or not. The "serve 10k and call it a day" instinct is not
