...
**Status: stable at v1.27.0 (2026-09-26), the tag cut from `7058767`.** Break campaign for it: [docs/break/campaign-v1.27.0.txt](docs/break/campaign-v1.27.0.txt), 57 probes, exit codes identical to v1.26.0.
