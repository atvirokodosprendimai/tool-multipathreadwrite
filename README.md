...
**Status: stable at v1.22.0 (2026-09-16), the tag cut from `6896442`.** Break campaign for it: [docs/break/campaign-v1.22.0.txt](docs/break/campaign-v1.22.0.txt), 55 probes, exit codes identical to v1.21.1.
