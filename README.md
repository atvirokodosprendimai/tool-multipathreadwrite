...
**Status: stable at v1.25.0 (2026-09-25), the tag cut from `9a586aa`.** Break campaign for it: [docs/break/campaign-v1.25.0.txt](docs/break/campaign-v1.25.0.txt), 57 probes, exit codes identical to v1.24.1.
