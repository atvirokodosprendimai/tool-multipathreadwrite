...
**Status: stable at v1.19.0 (2026-09-13), the tag cut from `93c8a1a`.** Break campaign for it: [docs/break/campaign-v1.19.0.txt](docs/break/campaign-v1.19.0.txt), 55 probes, the original 47 exit codes identical to v1.18.0.
