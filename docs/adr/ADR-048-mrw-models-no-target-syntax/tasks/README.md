...
Implementation tasks for ADR-048: mrw models no target syntax. See the parent ADR for the decision.
...
|----|-------|--------|--------|------------|
| T1 | Keep the engine line-oriented. Do not write a parser. | pending | — | `grep` the Accepted record |
