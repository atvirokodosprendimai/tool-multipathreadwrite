...
Implementation tasks for ADR-050: Windows state stays XDG until Windows is exercised. See the parent ADR for the decision.
...
|----|-------|--------|--------|------------|
| T1 | Keep the XDG path. Do not move it. | pending | — | `grep` the Accepted record |
