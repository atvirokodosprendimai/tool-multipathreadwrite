...
| `internal/mcp/partial_receipt_test.go` | new | `TestTheMCPReceiptOfAPartialCommitNamesEachHunk` (test only; `internal/mcp` code unchanged) |
...
- `internal/mcp` code is unchanged; only a test is added.
