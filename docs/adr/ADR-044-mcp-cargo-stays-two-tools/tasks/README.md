...
Implementation tasks for ADR-044: MCP cargo stays two tools. See the parent ADR for the decision.
...
|----|-------|--------|--------|------------|
| T1 | Keep two MCP tools. Do not add cargo. | pending | — | `grep` the Accepted record |
