...
Implementation tasks for ADR-049: Streaming apply waits for a size that hurts. See the parent ADR for the decision.
...
|----|-------|--------|--------|------------|
| T1 | Keep whole-file apply. Do not stream. | pending | — | `grep` the Accepted record |
