...
Implementation tasks for ADR-043: Torn Load is measured before anyone locks it. See the parent ADR for the decision.
...
|----|-------|--------|--------|------------|
| T1 | Write the observation recipe. Do not lock Load. | pending | — | `grep` the Accepted record |
