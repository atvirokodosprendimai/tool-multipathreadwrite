...
|----|-------|--------|--------|------------|
| T1 | Pin and drop README prose greps; keep AckRule and §75 | partial | — | `docs/adr/ADR-053-contract-does-not-grep-readme-prose/tasks/T1-drop-readme-prose-greps.md` fence |
