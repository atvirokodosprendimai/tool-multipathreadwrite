...
Implementation tasks for ADR-046: Host-cut under the ceiling is measured, not assumed. See the parent ADR for the decision.
...
|----|-------|--------|--------|------------|
| T1 | Write the observation recipe. Do not change licensing. | pending | — | `grep` the Accepted record |
