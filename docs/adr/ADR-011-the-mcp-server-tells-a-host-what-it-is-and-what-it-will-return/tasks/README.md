...
| T3 | Refuse a read that would not fit, instead of buffering it | done | — | 4 named `--- PASS:` lines, `# 42.` in `contract.sh`, `ask for a narrower range` in README, both engine clauses, `./scripts/contract.sh` |
