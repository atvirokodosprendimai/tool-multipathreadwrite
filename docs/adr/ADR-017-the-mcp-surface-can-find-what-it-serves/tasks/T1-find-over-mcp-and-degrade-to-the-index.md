...
- 2026-09-04 · 419967d* · mutant killed · exit 1 · `internal/mcp/tools.go` · S3: stop degrading an oversized SERVED page to the index. TestNoGrepAnswerExceedsTheDeclaredCap fails at 474,144 characters against a declared 200,000. ⚠ THIS TEST WAS GREEN AND HOLLOW TWICE before it could kill this: at 3,000 files and again at 12,001, because read.Run emits a per-file header, so ~3,000 files push the REPORT over the cap and the INDEX branch fires first — the served path is never reached. The bug lives in a narrow band (report fits, observed does not) and only 1,500 files sits in it. A fixture that resembles the report is not a fixture that reaches the bug · acceptance-sha256:6240852dc249e1c084a95d1ecd3379962f63338ad67d77618f849b06930b08b7
...
- 2026-09-04 · 419967d* · exit 0 · `set -o pipefail …` · acceptance-sha256:6240852dc249e1c084a95d1ecd3379962f63338ad67d77618f849b06930b08b7 · ms:39312
