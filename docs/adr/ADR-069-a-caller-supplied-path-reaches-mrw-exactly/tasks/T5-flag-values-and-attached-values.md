...
- 2026-09-26 · 31fe531* · exit 1 · `set -o pipefail …` · acceptance-sha256:952c7f98a81a29366f41769ec0a63d9fde0e327265ebeb4ca0d92442431f015d · ms:52514
  ```
  --- last 8 line(s) of stdout
  === RUN   TestAFlagValueDoesNotEndThePaddedArgGuard
  --- PASS: TestAFlagValueDoesNotEndThePaddedArgGuard (0.01s)
  === RUN   TestAnAttachedFlagValueWithTrailingSpaceIsRefused
  --- PASS: TestAnAttachedFlagValueWithTrailingSpaceIsRefused (0.02s)
  === RUN   TestTheIterRefusalKeepsTheVerb
  --- PASS: TestTheIterRefusalKeepsTheVerb (0.01s)
  PASS
  ok  	github.com/atvirokodosprendimai/tool-multipathreadwrite/cmd/mrw	0.127s
  ```
- 2026-09-26 · 31fe531* · exit 1 · `set -o pipefail …` · acceptance-sha256:952c7f98a81a29366f41769ec0a63d9fde0e327265ebeb4ca0d92442431f015d · ms:54061
  ```
  --- last 8 line(s) of stdout
  === RUN   TestAFlagValueDoesNotEndThePaddedArgGuard
  --- PASS: TestAFlagValueDoesNotEndThePaddedArgGuard (0.00s)
  === RUN   TestAnAttachedFlagValueWithTrailingSpaceIsRefused
  --- PASS: TestAnAttachedFlagValueWithTrailingSpaceIsRefused (0.00s)
  === RUN   TestTheIterRefusalKeepsTheVerb
  --- PASS: TestTheIterRefusalKeepsTheVerb (0.00s)
  PASS
  ok  	github.com/atvirokodosprendimai/tool-multipathreadwrite/cmd/mrw	0.190s
  ```
