...
Implementation tasks for ADR-047: Python str is taught as a line count. See the parent ADR for the decision.
...
|----|-------|--------|--------|------------|
| T1 | The teaching already rides in ADR-040 help. This task is the receipt. | pending | — | `grep` the Accepted record |
