...
|-----------|------|----------|--------|-------|
| `§69` | `scripts/contract.sh` | The built binary serves nothing and reports the withholding for `--max-lines 0`, and serves the whole file when the flag is absent | — | S1, S2 |
