...
readings were taken, plus a twelfth at 2 KB and 20 KB (reading 13) and a thirteenth on a harder
fixture (reading 14, evidence-limited; reading 12, the MCP arm, waits on ADR-023), each plan
committed before its trials, and every score file of the twelve scored readings committed
...
2.32× on a thirteen-service fixture through the bare tool result, reading 14, evidence-limited). Second,
...
the ceiling on both fixtures, and on a thirteen-service one on the fifteen strictly compliant trials
of reading 14 (evidence-limited; reading 17 re-runs it), so its curve cannot bend and says nothing
about where it would. The
